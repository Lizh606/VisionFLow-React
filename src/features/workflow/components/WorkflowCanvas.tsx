...
import { ThemeColors, Node, Connection, Position, Language, ThemeMode, NodeType } from '../../../types/index';
...
export const WorkflowCanvas: React.FC<WorkflowCanvasProps> = ({ 
  ...
  const renderMinimap = () => {
    ...
    return (
      <div 
        className="absolute bottom-6 z-40 transition-all duration-300 animate-in slide-in-from-bottom-2 fade-in hidden sm:block"
        style={{ 
          right: '80px', 
          width: mapWidth,
          height: mapHeight,
  ...
  return (
    ...
    >
      ...
      <div 
         className="absolute bottom-24 right-4 sm:bottom-6 sm:right-6 flex flex-col gap-2 z-50"
      >
         <div 
