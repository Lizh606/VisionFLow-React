...
import { ThemeColors, Language, NodeType, ThemeMode } from '../../../types/index';
...
export const ModelLibraryModal: React.FC<ModelLibraryModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 backdrop-blur-sm bg-black/40 animate-in fade-in duration-200">
      <div 
        className="w-full max-w-5xl h-full sm:h-[650px] rounded-2xl shadow-2xl flex flex-col overflow-hidden relative transition-all border"
        style={{ 
      ...
      >
        ...
        <div 
          className="px-4 sm:px-6 border-b shrink-0 overflow-x-auto" 
          style={{ 
            borderColor: borderColor,
           ...
           <div className="flex gap-8">
             {['types', 'custom', 'public'].map((tab) => (
                <button
                  ...
                  className={`py-3 text-xs font-bold uppercase tracking-wider relative transition-colors whitespace-nowrap ${
        ...
        <div className="flex-1 flex flex-col sm:flex-row overflow-hidden">
          ...
          <div 
             className="w-full sm:w-2/5 border-b sm:border-b-0 sm:border-r flex flex-col h-1/2 sm:h-full" 
             style={{ 
               borderColor: borderColor, 
               background: 'transparent' 
             }}
          ...
          <div 
            className="w-full sm:w-3/5 p-6 flex flex-col relative overflow-hidden h-1/2 sm:h-full"
            style={{ 
