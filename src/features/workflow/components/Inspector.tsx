...
import { ThemeColors, Node, Language, NodeType, Category, ThemeMode } from '../../../types/index';
import { Settings, Trash2, PanelRightClose, Layers, Search, ChevronDown, ChevronRight } from 'lucide-react';
import { translations } from '../../../i18n/index';
import { DRAGGABLE_NODES } from '../../../mocks';
...
export const Inspector: React.FC<RightPanelProps> = ({ 
  ...
  return (
    <div 
      className={`border-l flex flex-col z-30 transition-all duration-300 ease-[cubic-bezier(0.25,0.1,0.25,1)] whitespace-nowrap overflow-hidden bg-surface fixed sm:relative inset-y-0 right-0 ${showPanel ? 'w-full sm:w-80 opacity-100 translate-x-0' : 'w-0 opacity-0 translate-x-full border-none'}`}
      style={{ 
